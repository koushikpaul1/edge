object LearningScala1 {
  ...
  val hello: String = "Hola!"                     //> hello  : String = Holaaa!
  println(hello)                                  //> Holaaa!
  
  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.
  
  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = Holaaa!
  helloThere = hello + " There!"
  println(helloThere)                             //> Holaaa! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Holaaa!There!
  println(immutableHelloThere)                    //> Holaaa!There!
